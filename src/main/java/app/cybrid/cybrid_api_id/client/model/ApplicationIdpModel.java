...
@JsonPropertyOrder({
  ...
  ApplicationIdpModel.JSON_PROPERTY_UPDATED_AT
})
...
public class ApplicationIdpModel {
  ...
  **/
  ...
  public ApplicationIdpModel updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, clientId, scopes, createdAt, updatedAt);
  }
