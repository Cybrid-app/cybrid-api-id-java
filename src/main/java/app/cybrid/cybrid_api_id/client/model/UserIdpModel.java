 ...
 */
@JsonPropertyOrder({
  UserIdpModel.JSON_PROPERTY_GUID,
  UserIdpModel.JSON_PROPERTY_USERNAME,
  UserIdpModel.JSON_PROPERTY_EMAIL,
  UserIdpModel.JSON_PROPERTY_ALLOWED_SCOPES,
  UserIdpModel.JSON_PROPERTY_CREATED_AT,
  UserIdpModel.JSON_PROPERTY_UPDATED_AT
})
@JsonTypeName("User")
...
public class UserIdpModel {
  ...
  private JsonNullable<Set<AllowedScopesEnum>> allowedScopes = JsonNullable.<Set<AllowedScopesEnum>>undefined();
  ...
  **/
  ...
  public UserIdpModel allowedScopes(Set<AllowedScopesEnum> allowedScopes) {
    this.allowedScopes = JsonNullable.<Set<AllowedScopesEnum>>of(allowedScopes);
  ...
  public UserIdpModel addAllowedScopesItem(AllowedScopesEnum allowedScopesItem) {
    if (this.allowedScopes == null || !this.allowedScopes.isPresent()) {
      this.allowedScopes = JsonNullable.<Set<AllowedScopesEnum>>of(new LinkedHashSet<>());
    }
    try {
      this.allowedScopes.get().add(allowedScopesItem);
  ...
  **/
  ...
  public Set<AllowedScopesEnum> getAllowedScopes() {
        return allowedScopes.orElse(null);
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, user.guid) &&
        ...
        equalsNullable(this.allowedScopes, user.allowedScopes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, username, email, hashCodeNullable(allowedScopes), createdAt, updatedAt);
  }
