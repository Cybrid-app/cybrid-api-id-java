 ...
 */
@JsonPropertyOrder({
  ApplicationListIdpModel.JSON_PROPERTY_TOTAL,
  ApplicationListIdpModel.JSON_PROPERTY_PAGE,
  ApplicationListIdpModel.JSON_PROPERTY_PER_PAGE,
  ApplicationListIdpModel.JSON_PROPERTY_OBJECTS
})
@JsonTypeName("ApplicationList")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-04-08T00:39:30.587381Z[Etc/UTC]")
public class ApplicationListIdpModel {
  ...
  private List<ApplicationIdpModel> objects = new ArrayList<>();

  public ApplicationListIdpModel() { 
  }

  public ApplicationListIdpModel total(java.math.BigInteger total) {
  ...
  **/
  ...
  public ApplicationListIdpModel page(java.math.BigInteger page) {
  ...
  **/
  ...
  public ApplicationListIdpModel perPage(java.math.BigInteger perPage) {
  ...
  **/
  ...
  public ApplicationListIdpModel objects(List<ApplicationIdpModel> objects) {
    
    this.objects = objects;
    return this;
  }

  public ApplicationListIdpModel addObjectsItem(ApplicationIdpModel objectsItem) {
  ...
  **/
  ...
  public List<ApplicationIdpModel> getObjects() {
    return objects;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJECTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjects(List<ApplicationIdpModel> objects) {
    this.objects = objects;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplicationListIdpModel applicationList = (ApplicationListIdpModel) o;
    return Objects.equals(this.total, applicationList.total) &&
        Objects.equals(this.page, applicationList.page) &&
        Objects.equals(this.perPage, applicationList.perPage) &&
        Objects.equals(this.objects, applicationList.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationListIdpModel {\n");
