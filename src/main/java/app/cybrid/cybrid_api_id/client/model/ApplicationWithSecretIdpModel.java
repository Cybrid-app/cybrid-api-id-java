...
@JsonPropertyOrder({
  ...
  ApplicationWithSecretIdpModel.JSON_PROPERTY_UPDATED_AT,
...
public class ApplicationWithSecretIdpModel {
  ...
  **/
  ...
  public ApplicationWithSecretIdpModel updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, applicationWithSecret.name) &&
        ...
        Objects.equals(this.updatedAt, applicationWithSecret.updatedAt) &&
        Objects.equals(this.secret, applicationWithSecret.secret);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, clientId, scopes, createdAt, updatedAt, secret);
  }
