 ...
 */
@JsonPropertyOrder({
  PostUserIdpModel.JSON_PROPERTY_EMAIL
})
@JsonTypeName("PostUser")
...
public class PostUserIdpModel {
  public static final String JSON_PROPERTY_EMAIL = "email";
  private String email;

  public PostUserIdpModel() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The email address associated with the user.")
  ...
  public boolean equals(Object o) {
    ...
    PostUserIdpModel postUser = (PostUserIdpModel) o;
    return Objects.equals(this.email, postUser.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostUserIdpModel {\n");
