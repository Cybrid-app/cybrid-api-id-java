...
/**
 * API tests for BankApplicationsIdpApi
 */
@Ignore
public class BankApplicationsIdpApiTest {

    private final BankApplicationsIdpApi api = new BankApplicationsIdpApi();
     ...
     */
    @Test
    public void createBankApplicationTest()  {
        PostBankApplicationIdpModel postBankApplicationIdpModel = null;
        ApplicationWithSecretIdpModel response = api.createBankApplication(postBankApplicationIdpModel).block();
     ...
     */
    @Test
    public void listBankApplicationsTest()  {
        java.math.BigInteger page = null;
        java.math.BigInteger perPage = null;
        String bankGuid = null;
        ApplicationListIdpModel response = api.listBankApplications(page, perPage, bankGuid).block();
