...
/**
 * API tests for OrganizationApplicationsIdpApi
 */
@Ignore
public class OrganizationApplicationsIdpApiTest {

    private final OrganizationApplicationsIdpApi api = new OrganizationApplicationsIdpApi();
     ...
     */
    @Test
    public void createOrganizationApplicationTest()  {
        PostOrganizationApplicationIdpModel postOrganizationApplicationIdpModel = null;
        ApplicationWithSecretIdpModel response = api.createOrganizationApplication(postOrganizationApplicationIdpModel).block();
     ...
     */
    @Test
    public void listOrganizationApplicationsTest()  {
        java.math.BigInteger page = null;
        java.math.BigInteger perPage = null;
        ApplicationListIdpModel response = api.listOrganizationApplications(page, perPage).block();
