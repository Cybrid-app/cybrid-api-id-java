...
- Build date: 2024-06-19T16:18:09.903779Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-id-java:v0.118.33"
  }
```
...
- `target/cybrid-api-id-java-v0.118.33.jar`
- `target/lib/*.jar`
