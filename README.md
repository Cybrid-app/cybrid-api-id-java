...
- Build date: 2023-09-07T13:12:57.582474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-id-java:v0.91.11"
  }
```
...
- `target/cybrid-api-id-java-v0.91.11.jar`
- `target/lib/*.jar`
...
*UserIdpApi* | [**createUser**](docs/UserIdpApi.md#createUser) | **POST** /api/users | Create user
