...
- Build date: 2024-01-30T22:43:26.560854Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-id-java:v0.113.111"
  }
```
...
- `target/cybrid-api-id-java-v0.113.111.jar`
- `target/lib/*.jar`
